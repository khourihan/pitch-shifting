...
use crate::{fft::{istft, stft}, sample::AudioSample, signal::{SpectrumSignal, TimeDomainSignal}};
...
where
    ...
    F: Fn(f32, usize) -> T
{
    let new_len = (signal.num_samples() as f32 / hop_length as f32).ceil() as usize * hop_length + window_size;
